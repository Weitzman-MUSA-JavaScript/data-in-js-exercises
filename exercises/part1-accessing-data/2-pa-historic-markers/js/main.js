...
async function getHistoricMarkerData(corsproxykey, keyword, categories) {
  ...
  const url = `https://corsproxy.io/?key=${corsproxykey}&url=https://share.phmc.pa.gov/server/api/search/phmcmarkers?keyword=${keyword || ''}&countyCode=${philadelphiaCountyCode}&municipalities=${philadelphiaMunicipalityCode}${queryCategories}&markerMissing=`;
  try {
